	...
	var loadStorage = {
		...
		initBookMark: function () {
			Storage.bookMark = [{
				...
				name: "koolshare",
				url: "http://koolshare.cn/forum.php",
				icon: "icon/koolshare.png"
			}, {
				name: "虎扑",
